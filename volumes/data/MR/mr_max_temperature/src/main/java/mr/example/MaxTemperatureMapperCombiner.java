...
class MaxTemperatureMapperCombiner {
	public static void main(String[] args) throws Exception {
		...
		job.setCombinerClass(TemperatureReducer3.class);
...
class TemperatureMapper3 extends Mapper<LongWritable, Text, Text, IntWritable> {
...
class TemperatureReducer3 extends Reducer<Text, IntWritable, Text, IntWritable> {
